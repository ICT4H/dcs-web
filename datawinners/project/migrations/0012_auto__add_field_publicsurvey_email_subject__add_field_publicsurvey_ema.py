...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicSurvey.email_subject'
        db.add_column('project_publicsurvey', 'email_subject', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'PublicSurvey.email_body'
        db.add_column('project_publicsurvey', 'email_body', self.gf('django.db.models.fields.CharField')(default='', max_length=1024), keep_default=False)

        # Adding field 'PublicSurvey.custom_brand_logo'
        db.add_column('project_publicsurvey', 'custom_brand_logo', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicSurvey.email_subject'
        db.delete_column('project_publicsurvey', 'email_subject')

        # Deleting field 'PublicSurvey.email_body'
        db.delete_column('project_publicsurvey', 'email_body')

        # Deleting field 'PublicSurvey.custom_brand_logo'
        db.delete_column('project_publicsurvey', 'custom_brand_logo')
    ...
    models = {
        ...
        'project.publicsurvey': {
            ...
            'email_body': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024'}),
