...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PublicSurvey.email_body'
        db.alter_column('project_publicsurvey', 'email_body', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'PublicSurvey.email_body'
        db.alter_column('project_publicsurvey', 'email_body', self.gf('django.db.models.fields.CharField')(max_length=1024))
