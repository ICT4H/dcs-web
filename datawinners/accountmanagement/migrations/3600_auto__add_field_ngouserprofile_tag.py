...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NGOUserProfile.tag'
        db.add_column('accountmanagement_ngouserprofile', 'tag', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NGOUserProfile.tag'
        db.delete_column('accountmanagement_ngouserprofile', 'tag')
